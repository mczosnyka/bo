...
class Tableau:
    """
        ...
        objective_factors() -> numpy.Array:
            returns a vector containing factors in the cost row
        objective_value() -> float:
            returns the cost of solution represented in tableau
        is_optimal() -> bool:
    ...
    def objective_factors(self) -> ArrayLike:
    ...
    def is_optimal(self) -> bool:
        return self.objective_factors().min() >= -eps

    def choose_entering_variable(self) -> int:
        return self.objective_factors().argmin()
