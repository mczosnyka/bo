...
class Solution:
    ...
    def is_equivalent(self, other: Solution) -> bool:
        return self.value == other.value and self.weight == other.weight and self.optimal == other.optimal \
            and sorted(self.items, key=lambda i: i.index) == sorted(other.items, key=lambda i: i.index)
